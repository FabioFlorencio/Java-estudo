...
public class Exerc05 {
	...
	public static final double MEDIA_MAIOR_Q7= 7;	

	public static void main(String[] args) {

		Scanner scan = new Scanner(System.in);
		StringBuilder sb = new StringBuilder("Você foi ");		
		...
		for (int i = 0; i < qtdNotas; i++) {			
			...
			resultMedia += notas.get(i) / qtdNotas;
		}
			
		if (resultMedia == MEDIA_10) {
			sb.append("aprovado com distinção.");			
		} else if (resultMedia >= MEDIA_MAIOR_Q7) {
			sb.append("aprovado.");
		} else {
			sb.append("reprovado.");
		}
